...
enum GeneralResponseEntity {
    ...
    GeneralResponseEntity(final String fieldName) {
    ...
    public static GeneralResponseEntity fromString(final String lineFromBytes) {
    ...
    public void callHttpResponseBuilderWhenSupported(
            final HttpResponseBuilder builder, final String value) {
